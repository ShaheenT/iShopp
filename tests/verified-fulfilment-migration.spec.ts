...
describe("verified fulfilment migration contract", () => {
  it("defines the verified commercial-fact model", () => {
  ...
  it("enforces retailer/branch integrity and verified-rule overlap protection", () => {
  ...
  it("requires evidence before verification and while verified", () => {
  ...
  it("limits runtime fulfilment facts to effective verified delivery rules", () => {
